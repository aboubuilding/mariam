...
<footer class="footer-wrapper footer-layout1" data-bg-src="<?php bloginfo('template_directory'); ?>/assets/img/bg/footer-bg.png">
        <div class="shape-mockup footer-shape1 jump" data-left="60px" data-top="70px"><img
                src="<?php bloginfo('template_directory'); ?>/assets/img/normal/footer-bg-shape1.png" alt="img"></div>
        <div class="shape-mockup footer-shape2 jump-reverse" data-right="80px" data-bottom="120px"><img
                src="<?php bloginfo('template_directory'); ?>/assets/img/normal/footer-bg-shape2.png" alt="img"></div>
        ...
        <div class="footer-wrap" data-bg-src="<?php bloginfo('template_directory'); ?>/assets/img/bg/jiji.png">
                        ...
                        <div class="col-md-6 col-xxl-3 col-xl-3">
                            <div class="widget newsletter-widget footer-widget">
                                ...
                                <form class="newsletter-form form-group"><input class="form-control" type="email"
                                        ...
                                        type="submit" class="th-btn style3">Subscribe Now <i
                                            class="far fa-arrow-right ms-1"></i></button></form>
                            </div>
                        </div>
                    </div>
                </div>
